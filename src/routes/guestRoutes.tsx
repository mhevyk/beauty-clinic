...
const TreatmentsPage = lazy(() => import("@/pages/treatments/TreatmentsPage.tsx"));
const BookingFormPage = lazy(() => import("@/pages/booking-form/BookingFormPage.tsx"));
const BookSessionPage = lazy(() => import("@/pages/book-session/BookSessionPage.tsx"));
