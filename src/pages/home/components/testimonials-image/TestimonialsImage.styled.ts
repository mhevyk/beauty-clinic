...
export const PionFlowerDecoration = styled(PionFlowerDecorationSvg)({
  ...baseImageStyles,
  width: 132,
  height: 141,
...
export const SpiralSharpLeafDecoration = styled(SpiralSharpLeafDecorationSvg)({
  ...baseImageStyles,
  width: 129,
  height: 78,
...
export const OpenBananaDecoration = styled(OpenBananaDecorationSvg)({
  ...baseImageStyles,
...
export const ThickSharpLeafDecoration = styled(ThickSharpLeafDecorationSvg)({
  ...baseImageStyles,
...
export const SeaweedDecoration = styled(SeaweedDecorationSvg)({
  ...baseImageStyles,
